...
class Userdashboard extends CI_Controller {
    ...
    public function index() {
        ...
        $btn_journal_search = $this->input->post('btn_journal_search');
...
/////////////////////////////// Book ///////////////////
        if (isset($btn_journal)) {
            ...
            $journalTitle = $this->input->post('journal_name');
//            die($bookTitle);
            $Publisher = $this->input->post('publisher');
            $from = $this->input->post('from');
            $to = $this->input->post('to');
...
//            $Author = $this->input->post('author');
            $subject = $this->input->post('subject');
            $data['journal_list'] = $this->Search_model->search_journal($journalTitle, $Publisher, $year, $subject);
//            echo "<pre>";
//            print_r($data['journal_list']);
//            exit();
        }
        if (isset($btn_journal_search)) {
...
//            $Author = $this->input->post('author');
            $subject = $this->input->post('subject');
            $data['report_list'] = $this->Search_model->search_report($reportTitle, $Organization, $year, $keyword, $subject);
//            echo "<pre>";
//            print_r($data['journal_list']);
//            exit();
        }
...
//            $keyword = $this->input->post('keywords');
            $Author = $this->input->post('author');
            $subject = $this->input->post('subject');
            $data['thesis_list'] = $this->Search_model->search_thesis($thesisTitle, $year, $Department, $Author, $subject);
//            echo "<pre>";
//            print_r($data['journal_list']);
//            exit();
        }
