...
<ul class="sidebar-menu">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="<?= site_url('admin/author'); ?>"><i class="fa fa-pencil"></i>Author</a></li>
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="<?= site_url('admin/reports_subjects'); ?>"><i class="fa fa-copy"></i> Reports Subjects</a></li>   
